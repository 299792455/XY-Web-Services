      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <div className="relative ml-4 group">
            ...
            <a
              href="#contact"
              className="px-4 py-2 bg-gradient-to-r from-indigo-900/90 to-purple-900/90 rounded-lg text-white text-sm font-medium relative z-10"
            >
        ...
        <div className="space-y-1">
          ...
          <div className="px-4 pt-2">
            <a
              href="#contact"
              onClick={() => setMenuOpen(false)}
              className="contact-btn w-full px-4 py-2 bg-gradient-to-r from-indigo-700 to-purple-700 rounded-lg text-white text-sm font-medium"
            >
              <span className="bg-gradient-to-r from-cyan-300 to-indigo-300 bg-clip-text text-transparent">
                Contact
              </span>
