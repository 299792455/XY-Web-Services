...
export default function OfferSection() {
  return (
    <>
      <section id="services" className="w-full py-20 text-center">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="grid-offer text-left grid sm:grid-cols-2 md:grid-cols-2 gap-4 ">
            <div className="card relative">
              <div className="circle"></div>
              <div className="relative lg:pr-52">
                <h2 className="capitalize text-white mb-6 text-2xl xl:text-3xl">
                  Applications <br /> Web
                </h2>
      ...
      <style jsx global>{`
        ...
        .card::before {
          ...
          transition: 0.6s;
          z-index: 0;
          background: linear-gradient(to right, #312e81E5, #4c1d95E5);
        }
        .card:hover {
        ...
        .card:nth-child(1)::before {
          bottom: 0;
          right: 0;
          clip-path: circle(calc(3.125rem + 3.75vw) at 100% 100%);
        }
        .card:nth-child(2)::before {
          bottom: 0;
          left: 0;
          clip-path: circle(calc(3.125rem + 3.75vw) at 0% 100%);
        }
        .card:nth-child(3)::before {
          top: 0;
          right: 0;
          clip-path: circle(calc(3.125rem + 3.75vw) at 100% 0%);
        }
        .card:nth-child(4)::before {
          top: 0;
          left: 0;
          clip-path: circle(calc(3.125rem + 3.75vw) at 0% 0%);
        }
        .card p {
          transition: 0.8s;
        }
